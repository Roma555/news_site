{{-- Головний шаблон адмінки (кабінету адміністратора)--}}
{{-- підлеглий йому шаблон для контенту по адресі view->layouts->admin.blade.php--}}
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    ...
    <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
            <a class="nav-link" href="{{asset('my/account')}}">Вийти з адмін панелі</a>
        </li>
    </ul>
    <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
            <a class="nav-link" href="{{asset('logout')}}">Вийти</a>
        </li>
    </ul>
</nav>
<!-- ================================ END Header Navbar ============================================================ -->
