...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
   <h1>Додати Категорію</h1>
    ...
    <form method="post">
        {!! csrf_field() !!}
        <p> Введіть назву категорії новин: <br><input type="text" name="title" class="form-control" required></p>
        <p> Опис категорії новин: <br><textarea name="description" class="form-control"></textarea></p>
