...
<!-- hello world cherez controlers->view: resources-> views-> page1.blade.php -->
{{--<h1>{{ $message }}</h1>--}}
{{--<!DOCTYPE html>--}}
    {{--<html lang="en">--}}
    {{--<head>--}}
        ...
        {{--<link href="{{ asset('css/bootstrap.min.css') }}" rel="stylesheet">  <!-- підключаєм bootstrap через функцію asset-->--}}
        {{--<link href="{{ asset('css/jumbotron.css') }}" rel="stylesheet">      <!-- підключаєм css через функцію asset-->--}}
    ...
    {{--@foreach($articles as $article)                --}}{{--директива--}}
        {{--<h4><p>{{ $article->title }}</p></h4><br>  --}}{{-- отримуєм доступ до ячейки title таблиці article  --}}
        {{--<h5>{{!! $article->descript }}</h5><br>    --}}{{-- те саме що й зверху тыльки !! знымають екранування з тексту --}}
